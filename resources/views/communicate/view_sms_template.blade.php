        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="button-container">
                    <a href="{{ route('create.smstemplate') }}"><button type="button" class="btn btn-primary btn-sm mt-1">Add
                                    ...
                                    <tbody>
                                        @foreach ($smstemplates as $index => $template)
                                            <tr class="">
                                                ...
                                                <td>
                                                    <a href="{{ route('edit.smstemplate', $template->id) }}"
                                                        class="btn btn-info btn-sm">Edit</a>
                                                    <a href="{{ route('destroy.smstemplate', $template->id) }}"
