        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="button-container">
                    <a href="{{ route('create.sendsms') }}"><button type="button" class="btn btn-primary btn-sm mt-1">Add
                            SMS</button></a>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($sendsms as $index => $sms)
                                            <tr class="">
                                                ...
                                                <td class="">
                                                    {{ implode(' ', array_slice(str_word_count($sms->message, 1), 0, 15)) }}
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ route('edit.sendsms', $sms->id) }}"
                                                        class="btn btn-info btn-sm">Edit</a>
                                                    <a href="{{ route('destroy.sendsms', $sms->id) }}"
