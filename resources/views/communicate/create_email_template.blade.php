                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                method="POST"
                                action="{{ isset($emailtemplates) ? '/admin/emailtemplate/update/' . $emailtemplates->id : '/admin/emailtemplate/insert' }}" enctype="multipart/form-data">
                                @csrf
                                
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align"> Title*</label>
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="title" value="<?php echo isset($emailtemplates->title) ? $emailtemplates->title : '' ?>" class="form-control @error('title') is-invalid @enderror">
                                        @error('title')
