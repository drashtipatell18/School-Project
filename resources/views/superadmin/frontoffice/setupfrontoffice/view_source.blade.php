                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <div class="button-container">
                                    <a href="{{ route('create.source') }}"><button type="button"
                                            class="btn btn-primary btn-sm mb-2">Add Source</button></a>
                                </div>
                                <table class="table table-striped jambo_table bulk_action" id="table">
                                    ...
                                    <tbody>
                                        @foreach ($source as $index => $sour)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td>{{ $sour->source }}</td>
                                                <td>{{ $sour->description }}</td>
                                                <td>
                                                    <a href="{{ route('edit.source', $sour->id) }}"
                                                        class="btn btn-info btn-sm">Edit</a>

                                                    <a href="{{ route('destroy.source', $sour->id) }}"
