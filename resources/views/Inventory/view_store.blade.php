                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <div class="button-container">
                                    <a href="{{ route('create.store') }}"><button type="button" class="btn btn-primary btn-sm mb-2">Add Item Store</button></a>
                                </div>
                                        ...
                                        @foreach ($stores as $index => $store)
                                            <tr class="">
                                                ...
                                                <td> 
                                                    ...
                                                    <a href="{{ route('destroy.store',$store->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
