        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="button-container">
                    <a href="{{ route('create.store') }}"><button type="button" class="btn btn-primary btn-sm mt-1">Add Item
                            Store</button></a>
                </div>
            </div>
                                    ...
                                    <tbody>
                                        @foreach ($stores as $index => $store)
                                            <tr class="">
                                                ...
                                                <td class="">
                                                    {{ implode(' ', array_slice(str_word_count($store->description, 1), 0, 15)) }}
                                                </td>
                                                <td>
                                                    <a href="{{ route('edit.store', $store->id) }}"
                                                        class="btn btn-info btn-sm">Edit</a>
                                                    <a href="{{ route('destroy.store', $store->id) }}"
