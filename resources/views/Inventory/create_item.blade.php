        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="button-container">
                    <a href="{{ route('items') }}"><button type="button" class="btn btn-primary btn-sm mt-1">View
                            Item </button></a>
                </div>
            </div>
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="name" value="<?php echo isset($items->name) ? $items->name : ''; ?>"
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <select name="category"
                                            ...
                                            @foreach ($category as $cat)
                                                <option value="{{ $cat }}"
                                                    {{ isset($items->category) && $items->category == $cat ? 'selected' : '' }}>
                                                    {{ $cat }}</option>
                                            @endforeach
                                        </select>
                                        @error('category')
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" name="unit" value="<?php echo isset($items->unit) ? $items->unit : ''; ?>"
