                        ...
                        <div class="x_content">
                            <div class="table-responsive">
                                <div class="button-container">
                                    <a href="{{ route('create.book') }}"><button type="button" class="btn btn-primary btn-sm mb-2">Add Book</button></a>
                                </div>
                                    ...
                                    <tbody>
                                        @foreach ($books as $index => $book)
                                            <tr class="">
                                                ...
                                                <td> 
                                                    <a href="{{ route('edit.book', $book->id) }}" class="btn btn-info btn-sm">Edit</a>
                                                    <a href="{{ route('destroy.book',$book->id) }}" class="btn btn-danger btn-sm"onclick="return confirm('Are you sure you want to delete this ?');">Delete</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
